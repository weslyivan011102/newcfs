...
const Index = () => {
   ...
   const fetchAdvanceBills = async ({ queryKey }) => {
      ...
      const response = await axios.get(`${API_URL}/api/get_advancebillx`, {
         params: {
            page,
            lastname: query,
            sortColumn,
   ...
   const { advance_bills } = usePage().props;

   const [searchQuery, setSearchQuery] = useState("");
   const [currentPage, setCurrentPage] = useState(
      advance_bills?.current_page || 1
   );
   ...
   const deleteBill = async (advanceId) => {
      const confirmDelete = window.confirm(
         "Are you sure you want to delete this advance bill?"
      );
      if (confirmDelete) {
         try {
            const response = await axios.delete(`/advance_bills/${advanceId}`);
         ...
         <div className="bg-white overflow-y-auto max-h-[590px]">
            <div className="mt-5  px-4">
               ...
               <div className="w-full  flex items-center justify-between flex-col-reverse gap-2 lg:flex-row">
                  ...
                  <div>
                     <Link href="/advance_bills/create">
                        <Button
                        ...
                        <tr>
                           ...
                           >
                              <div className="flex justify-center items-center gap-2">
                                 No advance_bills records found
