...
const Create = ({ customers, collectors }) => {
   ...
   const customerOptions = Object.values(customers).map((customer) => ({
      value: customer.customer.id,
      label: `${customer.customer.lastname} ${customer.customer.firstname}`,
   }));
                        ...
                        <div className="mb-3">
                           ...
                           <Select
                              ...
                              value={collectorOptions.find(
                                 (option) => option.value === data.collector_id
                              )}
