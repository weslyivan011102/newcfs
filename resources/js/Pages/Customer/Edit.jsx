                  ...
                  >
                     ...
                     <form onSubmit={onSubmit} className="mt-8 mb-2">
                        ...
                        <div className="mb-3">
                           ...
                           <Input
                              type="date"
                              value={data.disconnection}
                              onChange={(e) =>
                                 setData("disconnection", e.target.value)
                              }
                              error={Boolean(errors.disconnection)}
                              size="md"
                           />
                        </div>
                        <div className="mb-3">
                           ...
                           <Input
                              type="date"
                              value={data.banned_date}
                              onChange={(e) =>
                                 setData("banned_date", e.target.value)
                              }
                              error={Boolean(errors.banned_date)}
                              size="md"
                           />
                        </div>
